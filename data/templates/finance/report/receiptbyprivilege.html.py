...
_magic_number = 2
_modified_time = 1553493777.719703
_template_filename='/usr/local/python2.5/lib/python2.5/site-packages/srjvkk-0.0.0dev-py2.5.egg/srjvkk/templates/finance/report/receiptbyprivilege.html'
_template_uri='/finance/report/receiptbyprivilege.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 9
        context.write(unicode(h.url_for('/js/finance/receiptbyprivilege.js')))
        ...
        # SOURCE LINE 56
        context.write(unicode(h.url_for('/financereport/print_receipt_by_privilege')))
