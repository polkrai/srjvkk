...
_magic_number = 2
_modified_time = 1552456838.1508479
_template_filename='/usr/local/python2.5/lib/python2.5/site-packages/srjvkk-0.0.0dev-py2.5.egg/srjvkk/templates/finance/report/printlabview.html'
_template_uri='/finance/report/printlabview.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 19
        context.write(unicode(h.url_for('/financereport/print_labs')))
